 ...
 * *
 * Description: IjkExoPlayer(version r1.5.11) for ArtVideoPlayer
 * *
 */
public class IjkExoPlayer extends AbsMediaPlayer implements IMediaPlayer.OnPreparedListener, IMediaPlayer.OnCompletionListener, IMediaPlayer.OnBufferingUpdateListener, IMediaPlayer.OnSeekCompleteListener, IMediaPlayer.OnErrorListener, IMediaPlayer.OnInfoListener, IMediaPlayer.OnVideoSizeChangedListener {

    private tv.danmaku.ijk.media.exo.IjkExoMediaPlayer mediaPlayer;

    private Context mAppContext;

    public IjkExoPlayer(@NonNull Context context) {
