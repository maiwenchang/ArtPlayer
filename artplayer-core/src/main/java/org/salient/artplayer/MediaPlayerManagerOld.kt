...
//
//    var mediaPlayer: AbsMediaPlayer<*>? = null //播放器内核
//
//    /**
//     * 设置静音
//     *
...
//     */
//    fun playAt(target: VideoViewOld?) {
...
//     * 绑定重力感应横竖屏管理
//     */
//    fun bindOrientationManager(context: Context, videoViewOld: VideoViewOld) {
//        mOrientationEventManager?.orientationDisable()
//        mOrientationEventManager?.orientationEnable(context, videoViewOld, mOnOrientationChangeListener)
//    }
//
//    /**
//     * 设置重力感应横竖屏管理
...
//        }
//        val currentFloor = currentVideoViewOld
...
//    }
//
//    fun addTextureView(videoViewOld: VideoViewOld) {
//        if (textureView == null) {
//            return
//        }
...
//                ViewGroup.LayoutParams.MATCH_PARENT,
//                Gravity.CENTER)
//        videoViewOld.textureViewContainer?.addView(textureView, layoutParams)
//    }
//
...
//        if (currentVideoViewOld == null) return
...
//        Log.i(TAG, "backPress")
//        try {
//            val currentVideoView = currentVideoViewOld
//            if (currentVideoView != null && currentVideoView.windowType == VideoViewOld.WindowType.FULLSCREEN) { //退出全屏
...
//        get() {
//            val currentVideoView = currentVideoViewOld ?: return null
//            return currentVideoView.controlPanel
//        }
//
//    // all possible MediaPlayer states
//    enum class PlayerState {
//        ERROR, IDLE, PREPARING, PREPARED, PLAYING, PAUSED, STOP, PLAYBACK_COMPLETED
//    }
//
...
//                val currentVideoView = currentVideoViewOld ?: return
